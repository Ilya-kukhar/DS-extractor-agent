...
4. **Привяжи к родительскому понятию SPF.** Прочитай `SPF/ontology.md` секция 2 — найди подходящее U.* понятие. Укажи «FPF-понятие» или «Родительское понятие (SPF)».
5. **Создай содержимое** по шаблону (шаблоны — в `prompts/session-close.md`, шаг 4d).

### Шаг 5: Проверка противоречий и онтологии

> **ОБЯЗАТЕЛЬНО.** Для каждого кандидата — проверь совместимость с существующим знанием и онтологией.
...
4. Для reject — ничего.
5. Для defer — запиши в `DS-my-strategy/inbox/`.
